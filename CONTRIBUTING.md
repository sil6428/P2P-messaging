...
1. **Full attachment-transfer integration** — this repository only binds and
   ...
   download/quarantine directory convention, progress, and safe resume, is
   still unclaimed.
...
5. **Connection-pressure controls** — add a global cap and tests for many
   concurrent unauthenticated or slow connections without weakening the
   authenticated-peer limiter.
